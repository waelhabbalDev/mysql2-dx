...
export interface QueryRunner {
    ...
    insert(table: string, data: Record<string, MySQLPrimitive | RawSql>): Promise<ResultSetHeader>;
    insertMany(table: string, data: Record<string, MySQLPrimitive | RawSql>[]): Promise<ResultSetHeader>;
    update(table: string, data: Record<string, MySQLPrimitive | RawSql>, where: WhereCondition): Promise<ResultSetHeader>;
